...
const MODE_PROMPTS = {
  ...
  correction: "LEKTORAT MODE: Correct only relevant spelling, grammar, punctuation, and clear dictation artifacts in the supplied text. Preserve existing headings and OPB when present. Do not add content, stylistically rewrite, or change medical meaning. Return the complete corrected text as one Writing Block in the text field; list actual changes below it, and list visible medical or logical issues only as notes without correcting them.",
