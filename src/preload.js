...
contextBridge.exposeInMainWorld("radimoAgent", {
  ...
  getFieldMapperStatus: () => ipcRenderer.invoke("field-mapper:status"),
  setFieldMapperConfig: (payload) => ipcRenderer.invoke("field-mapper:set-config", payload),
  scanFieldWindow: (payload) => ipcRenderer.invoke("field:scan-window", payload),
